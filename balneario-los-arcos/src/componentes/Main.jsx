const MainSection = () => {
    return (
        <section className="w-full min-h-screen bg-cover bg-center bg-no-repeat flex flex-col justify-center items-center text-center text-[#F5EBE0] font-nunito px-4 relative" style={{backgroundImage: 'url("/src/assets/main.png")', }}>
